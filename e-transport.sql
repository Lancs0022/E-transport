...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `IDABONNEMENT` smallint NOT NULL,
  `NOMCLIENT` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `PRENOMCLIENT` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `client` (`IDCLIENT`, `IDABONNEMENT`, `NOMCLIENT`, `PRENOMCLIENT`, `TELEPHONECLIENT`, `MDP`, `TARIF`) VALUES
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lorsqu''un client effectue une reservation, des places seront automatiquement deduits';
...
(3, 3, '07:25:00', '1', 'it2'),
(4, 8, '07:15:00', '6', '1'),
(5, 9, '06:00:00', '1', 'itineraire 1'),
(6, 9, '14:00:00', '2', 'itineraire 3');
